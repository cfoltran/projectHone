...
class TweetByRegion:
    ...
    def retrieveTweets(self): 
        ...
        elif self.region == 'Nouvelle-Aquitaine':
        ...
        elif self.region == 'Centre-Val_de_Loire':
...
s = TweetByRegion("IDF","#Macron")
print(s.retrieveTweets())
#print(s.displayTweetsByRegion())
